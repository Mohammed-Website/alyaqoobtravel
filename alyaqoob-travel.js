        ...
        if (messageBar.value.trim() !== "") {
            ...
            let botResponse = `
                <div class="chat response">
                    <img src="https://mohammed-website.github.io/alyaqoobtravel/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A/%D9%85%D9%83%D8%AA%D8%A8-%D8%B3%D9%8A%D8%A7%D8%AD%D9%8A-%D8%A8%D8%AD%D8%B1%D9%8A%D9%86%D9%8A.png">
                    <span class="new">...</span>
                </div>
            `;
...
const sectionData = [
    {
        title: 'عروض طرابزون',
        image_1: ['مكتب-سياحي-بحريني/عروض-طرابزون/عرض-طرابزون-1.jpg', 'عرض طرابزون & باتومي'],
        image_2: ['مكتب-سياحي-بحريني/عروض-طرابزون/عرض-طرابزون-2.jpg', 'عرض طرابزون & باتومي'],
        image_3: ['مكتب-سياحي-بحريني/عروض-طرابزون/عرض-طرابزون-3.jpg', 'عرض طرابزون & باتومي'],
        image_4: ['مكتب-سياحي-بحريني/عروض-طرابزون/عرض-طرابزون-4.jpg', 'عرض طرابزون & ريزا'],
    },

    {
        title: 'عروض تايلاند',
        image_1: ['مكتب-سياحي-بحريني/عروض-تايلاند/عرض-تايلاند-1.jpg', 'بوكيت & كرابي & بتايا & بانكوك'],
        image_2: ['مكتب-سياحي-بحريني/عروض-تايلاند/عرض-تايلاند-2.jpg', 'عرض تايلاند - بوكيت & بانكوك'],
    },

    {
        title: 'عروض روسيا',
        image_1: ['مكتب-سياحي-بحريني/عروض-روسيا/عرض-روسيا-1.jpg', 'عرض روسيا - موسكو'],
        image_2: ['مكتب-سياحي-بحريني/عروض-روسيا/عرض-روسيا-2.jpg', 'عرض روسيا - موسكو'],
    },


    {
        title: 'عروض موسكو',
        image_1: ['مكتب-سياحي-بحريني/عروض-موسكو/عرض-موسكو-1.jpg', 'عرض موسكو - اليوم الوطني البحريني'],
    },

    {
        title: 'عروض اذربيجان',
        image_1: ['مكتب-سياحي-بحريني/عروض-اذربيجان/عرض-اذربيجان-1.jpg', 'عرض اذربيجان - باكو & خيزي'],
    },

    {
        title: 'عروض البوسنة',
        image_1: ['مكتب-سياحي-بحريني/عروض-البوسنة/عرض-البوسنة-1.jpg', 'عرض البوسنة - فيسوكو & سراييفو'],
    },

    {
        title: 'عروض اسطنبول',
        image_1: ['مكتب-سياحي-بحريني/عروض-اسطنبول/عرض-اسطنبول-1.jpg', 'عرض اسطنبول & سراييفو'],
    },
];
...
function openFullScreenImage(src, text) {
    ...
    whatsappButton.href = `https://wa.me/+97339901908?text=طلب%20حجز%20هذا%20العرض:%0A%0Ahttps://mohammed-website.github.io/alyaqoobtravel/${encodeURIComponent(src)}`;
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "شكرا اليعقوب البحرين على اتقانكم  بالعمل وعلى خدمتكم الجميله بارك الله فيكم وفي جهودكم الى الاعلى بإذن",
        stars: 5
    },
    {
        profileImage: "https://mughader.com/مكتب-للسفر-والسياحة/مكتب-للسفر-والسياحة-3.png",
        personName: "ناصر الهزاع",
        comment: "اشكر طاقم شركة اليعقوب البحرين على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "نشكر شركة اليعقوب البحرين على جهوده وتمنى له دائم التوفيق و والــــنــــجـــــاح",
        stars: 5
    },
    {
        profileLetter: "H",
        personName: "Hala Abdullah",
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة اليعقوب البحرين للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
        personName: "سامي الموسى",
        comment: "صراحه مجهود يشكر عليه من شركة اليعقوب البحرين للسفر والسياحة ومن افضل الشركات الي حريصه علئ ادق التفاصيل شركه تلبي جميع احتيجاتك وعن تجربه اتكلم صراحه تعاملهم جدا راقي بجميع الاماكن والاوقات ❤️❤️",
        stars: 5
    },
];
...
function mughader_generateComments(comments) {
    ...
    comments.forEach(({ profileLetter, profileImage, personName, comment, stars }, index) => {
        ...
        if (profileImage) {
            ...
            img.alt = `مكتب سياحي - شركة اليعقوب`;
            img.title = `مكتب سياحي - شركة اليعقوب`;
...
openWhatsAppNumber = function () {
    ...
    const whatsappNumber = "+97339901908";
